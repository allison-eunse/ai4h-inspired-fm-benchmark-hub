# Robustness Evaluation Report: ROBUSTNESS-dummy_classifier-20251127-065232

## Overview

- **Model**: dummy_classifier
- **Benchmark**: Robustness Testing (ITU AI4H DEL3 Aligned)
- **Date**: 2025-11-27 06:52 UTC
- **brainaug-lab Integration**: ✓ Available
...
|--------|-------|
| **dropout_rAUC** | 0.5186 |
| **line_noise_rAUC** | 0.4901 |
| **noise_rAUC** | 0.4003 |
| **perm_equivariance** | 0.7819 |
| **robustness_score** | 0.4554 |
| **shift_rAUC** | 0.4126 |
